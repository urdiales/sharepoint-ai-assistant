...
**📂 Choose your download method based on where the files are hosted:**

**Option A: GitLab Repository** 🦊
...
1. **📂 Go to the GitHub project page** (ask your admin for the link)
2. **⬇️ Download the project:**
...
**Option C: Using Git (if you have Git installed)** 🔧
...
- Download the folder with all the files (ask your admin or get the files from your team's shared link)
